...
public class StartEmptyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Recogemos los arguments que se envia a si mismo a traves del MainActivity

     /*   if (getNombre != null){
            Log.v(TAG, "recibido nombre NO NULO: " + getNombre + " y edad: " + getEdad);
            //getNombre = getArguments().getString("nombre");
        }
        if (getEdad != null){
            getEdad = getArguments().getString("edad");
        }



        Log.v(TAG, "recibido nombre: " + getNombre + " y edad: " + getEdad);*/
